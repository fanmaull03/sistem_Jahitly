<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 grid gap-4 sm:grid-cols-2">
        ...
        <div class="sm:col-span-2">
            <x-input-label for="update_password_current_password" :value="__('Password Saat Ini')" class="text-sm font-semibold text-stone-700" />
            <x-text-input
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('Password Baru')" class="text-sm font-semibold text-stone-700" />
            <x-text-input
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Konfirmasi Password')" class="text-sm font-semibold text-stone-700" />
            <x-text-input
